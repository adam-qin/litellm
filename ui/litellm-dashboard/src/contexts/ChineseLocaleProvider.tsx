...
const TEXT_TRANSLATIONS: Record<string, string> = {
  ...
  "Describe the purpose of this access group...": "描述该访问组的用途...",
  ...
  "No MCP servers assigned to this group": "该访问组尚未分配 MCP 服务器",
  "No agents assigned to this group": "该访问组尚未分配智能体",
  "Show Less": "收起",
  Resources: "资源",
  Updated: "更新时间",
  Agents: "智能体",
  ...
  "Resolved Guardrails:": "已解析护栏：",
  "Guardrail Settings": "护栏设置",
  "LiteLLM Tool Permission Guardrail": "XHub 工具权限护栏",
  "LiteLLM Content Filter": "XHub 内容过滤器",
  "LiteLLM LLM as a Judge": "XHub LLM 评审护栏",
  "Guardrail Garden": "护栏广场",
  "Built-in Content Filter": "内置内容过滤器",
  "Partner Guardrails": "合作伙伴护栏",
  "Partner Guardrail": "合作伙伴护栏",
  ...
  "部分策略绑定能力将在后续版本中作为 XHub 企业功能提供。": "部分策略绑定能力将在后续版本中作为 XHub 企业功能提供。",
