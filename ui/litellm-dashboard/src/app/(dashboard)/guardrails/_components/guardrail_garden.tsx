...
const GuardrailGarden: React.FC<GuardrailGardenProps> = ({ accessToken, onGuardrailCreated }) => {
  ...
  return (
    <div>
      ...
      {/* Built-in Content Filter Section */}
      <div style={{ marginBottom: 40 }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 4 }}>
          <h2 style={{ fontSize: 20, fontWeight: 600, color: "#111827", margin: 0 }}>Built-in Content Filter</h2>
          <span
            style={{
              display: "inline-flex",
              alignItems: "center",
        ...
        <p style={{ fontSize: 13, color: "#6b7280", margin: "4px 0 20px 0" }}>
          Built-in guardrails with zero latency, no external dependencies, and no additional cost.
        </p>
        <div
          style={{
            display: "grid",
